...
##[1.23.3.1] 2018-03-20;
### Fixed
- some calls to `dirname` made using PHP 7.0 syntax
...
##[1.23] 2018-03-03;
### Changed
- moved support for PHP 5.6 of the package into this branch (`php-56-compat`)
...
[unreleased]: https://github.com/lucatume/wp-browser/compare/1.24.1...HEAD
[1.24.1]: https://github.com/lucatume/wp-browser/compare/1.24...1.24.1
[1.24]: https://github.com/lucatume/wp-browser/compare/1.23.3.3...1.24
...
[1.23.1]: https://github.com/lucatume/wp-browser/compare/1.23...1.23.1
[1.23]: https://github.com/lucatume/wp-browser/compare/1.22.8...1.23
