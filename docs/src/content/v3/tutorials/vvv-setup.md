...
![vagrant up command result](/assets/v3/tutorials/images/vvv-up.png)
...
![vagrant ssh command result](/assets/v3/tutorials/images/vvv-ssh.png)
...
![](/assets/v3/tutorials/images/vvv-my-plugin-shows.png)
...
![](/assets/v3/tutorials/images/vvv-my-plugin-composer-init.png)
...
![](/assets/v3/tutorials/images/vvv-codecept-version.png)
...
![](/assets/v3/tutorials/images/vvv-wp-db-backup.png)
...
![](/assets/v3/tutorials/images/vvv-wp-browser-init-1.png)
![](/assets/v3/tutorials/images/vvv-wp-browser-init-2.png)
