<?php //[STAMP] d26114022181b121a646b24539507424
...
trait FunctionalTesterActions
{
    ...
    public function haveUserInDatabase($user_login, $user_id, $role = null, $userData = null) {
        $this->getScenario()->runStep(new \Codeception\Step\Action('haveUserInDatabase', func_get_args()));
    }
     ...
     *
     * @return void
     * @see \Codeception\Module\WPDb::javeInDatabase()
     */
    public function javeInDatabase($table, $data)
    {
        $this->getScenario()->runStep(new \Codeception\Step\Action('javeInDatabase', func_get_args()));
    }
    ...
    public function canSeeSerializedOptionInDatabase($criteria) {
        $this->getScenario()
            ->runStep(new \Codeception\Step\ConditionalAssertion('seeSerializedOptionInDatabase', func_get_args()));
    }
    /**
     * [!] Method is generated. Documentation taken from corresponding module.
     *
    ...
    public function seeSerializedOptionInDatabase($criteria) {
        $this->getScenario()
            ->runStep(new \Codeception\Step\Assertion('seeSerializedOptionInDatabase', func_get_args()));
    }
    ...
    public function canSeeOptionInDatabase($criteria) {
        $this->getScenario()
            ->runStep(new \Codeception\Step\ConditionalAssertion('seeOptionInDatabase', func_get_args()));
    }
    /**
     * [!] Method is generated. Documentation taken from corresponding module.
     *
    ...
    public function cantSeeSerializedOptionInDatabase($criteria) {
        $this->getScenario()
            ->runStep(new \Codeception\Step\ConditionalAssertion('dontSeeSerializedOptionInDatabase', func_get_args()));
    }
    /**
     * [!] Method is generated. Documentation taken from corresponding module.
     *
    ...
    public function dontSeeSerializedOptionInDatabase($criteria) {
        $this->getScenario()
            ->runStep(new \Codeception\Step\Assertion('dontSeeSerializedOptionInDatabase', func_get_args()));
    }
    ...
    public function cantSeeOptionInDatabase($criteria) {
        $this->getScenario()
            ->runStep(new \Codeception\Step\ConditionalAssertion('dontSeeOptionInDatabase', func_get_args()));
    }
    /**
     * [!] Method is generated. Documentation taken from corresponding module.
     *
    ...
    public function dontSeeOptionInDatabase($criteria) {
        $this->getScenario()->runStep(new \Codeception\Step\Assertion('dontSeeOptionInDatabase', func_get_args()));
    }
    ...
    public function canSeePostMetaInDatabase($criteria) {
        $this->getScenario()
            ->runStep(new \Codeception\Step\ConditionalAssertion('seePostMetaInDatabase', func_get_args()));
    }
    /**
     * [!] Method is generated. Documentation taken from corresponding module.
     *
    ...
    public function haveLinkInDatabase($link_id, $data = null) {
        $this->getScenario()->runStep(new \Codeception\Step\Action('haveLinkInDatabase', func_get_args()));
    }
