<?php  //[STAMP] 4683a1aa07f96da791ce886683dc74ee
// phpcs:ignoreFile
...
trait ClimoduleTesterActions
{
     ...
     *
     *
     * @see \Helper\Climodule::setCliEnv()
     */
    public function setCliEnv($key, $value) {
        return $this->getScenario()->runStep(new Action('setCliEnv', func_get_args()));
    }
    ...
    public function cli(array|string $command = ["core", "version"], ?array $env = NULL, mixed $input = NULL): int {
        return $this->getScenario()->runStep(new Action('cli', func_get_args()));
    }
    ...
    public function grabLastCliProcess(): CliProcess {
        return $this->getScenario()->runStep(new Action('grabLastCliProcess', func_get_args()));
    }
    ...
    public function grabLastShellOutput(): string {
        return $this->getScenario()->runStep(new Action('grabLastShellOutput', func_get_args()));
    }
    ...
    public function grabLastShellErrorOutput(): string {
        return $this->getScenario()->runStep(new Action('grabLastShellErrorOutput', func_get_args()));
    }
    ...
    public function cliToArray(array $command, ?callable $splitCallback = NULL, ?array $env = NULL, mixed $input = NULL): array {
        return $this->getScenario()->runStep(new Action('cliToArray', func_get_args()));
    }
    ...
    public function cliToString(array $command, ?array $env = NULL, mixed $input = NULL): string {
        return $this->getScenario()->runStep(new Action('cliToString', func_get_args()));
    }
    ...
    public function dontSeeShellOutputMatches(string $regex): void {
        $this->getScenario()->runStep(new Action('dontSeeShellOutputMatches', func_get_args()));
    }
    /**
     * [!] Method is generated. Documentation taken from corresponding module.
     *
    ...
    public function cantSeeShellOutputMatches(string $regex): void {
        $this->getScenario()->runStep(new ConditionalAssertion('dontSeeShellOutputMatches', func_get_args()));
    }
