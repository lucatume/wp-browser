<?php  //[STAMP] 1819b0c77ebad82f28e30032caa8f8bd
...
trait ClimoduleTesterActions
{
     ...
     */
    public function cli($userCommand = "core version", $env = [], $inherit_env = true) {
     ...
     */
    public function cliToArray($userCommand = "post list --format=ids", $splitCallback = NULL, $env = [], $inherit_env = true) {
     ...
     */
    public function cliToString($userCommand, $env = [], $inherit_env = true) {
