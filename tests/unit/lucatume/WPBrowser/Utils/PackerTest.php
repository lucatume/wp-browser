...
class PackerTest extends Unit
{
    ...
    public function test_unpack_keeps_wrapper_registered_after_exception(): void
    {
        ...
        } catch (PackerException $exception) {
            // Expected.
        }
    ...
    {
        $packer = new Packer();
        $closure = static function ($value): bool {
...
class PackerStaticPropertyHost
{
     ...
     * @var string
     */
    public $instanceName = 'host';
    /**
     * @var int
     */
    public $instanceValue = 7;
}
