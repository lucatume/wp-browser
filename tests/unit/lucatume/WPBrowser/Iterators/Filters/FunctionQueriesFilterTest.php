...
use lucatume\WPBrowser\Iterators\Filters\FunctionQueriesFilter as Filter;
use UnitTester;

class FunctionQueriesFilterTest extends Unit
{
    ...
    private function make_instance($f = ''): FunctionQueriesFilter
    {
