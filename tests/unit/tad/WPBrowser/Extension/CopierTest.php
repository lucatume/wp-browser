...
class CopierTest extends \Codeception\Test\Unit
{
    ...
    public function it_should_write_source_folder_to_destination_folder()
    {
        ...
        $this->assertEquals('some sub file 2 content', file_get_contents($destination . '/sub-folder/sub-folder-2/some-sub-file-2'));
    }
    ...
    public function it_should_copy_multiple_files_and_structures()
    {
        ...
        $this->assertEquals('some sub file 2 content', file_get_contents($destination . '/sub-src-folder/sub-src-folder-2/some-sub-file-2'));
        ...
        $this->assertEquals('some sub file content', file_get_contents($destinationThree . '/sub-src-folder/some-sub-file'));
        ...
        $this->assertEquals('some sub file 2 content', file_get_contents($destinationThree . '/sub-src-folder/sub-src-folder-2/some-sub-file-2'));
    }
