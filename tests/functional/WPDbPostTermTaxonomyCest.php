...
class WPDbPostTermTaxonomyCest {
	...
	public function it_should_allow_assigning_a_post_an_existing_taxonomy_term( FunctionalTester $I ) {
		...
		$I->seeInDatabase( $I->grabTermTaxonomyTableName(), [ 'term_taxonomy_id' => $termTaxonomyId, 'taxonomy' => 'some_taxonomy', 'count' => 1 ] );
	}
	...
	public function it_should_allow_inserting_many_posts_with_same_term( FunctionalTester $I ) {
		...
		$I->seeInDatabase( $I->grabTermTaxonomyTableName(), [ 'term_taxonomy_id' => $termTaxonomyId, 'taxonomy' => 'taxonomy_three', 'count' => 5 ] );
	}
