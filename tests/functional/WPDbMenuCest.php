...
class WPDbMenuCest
{
     ...
     */
    public function it_should_throw_if_trying_to_add_menu_when_theme_not_set(FunctionalTester $I): void
    {
        try {
     ...
     */
    public function it_should_throw_if_trying_to_add_menu_items_when_theme_not_set(FunctionalTester $I): void
    {
        try {
     ...
     */
    public function it_should_allow_adding_menus_to_different_themes(FunctionalTester $I): void
    {
        $I->useTheme('foo3');
     ...
     */
    public function it_should_throw_if_trying_to_add_items_to_non_existing_menu(FunctionalTester $I): void
    {
        try {
            $I->useTheme('foo');
     ...
     */
    public function it_should_allow_adding_menu_items_to_menus(FunctionalTester $I): void
    {
        $I->useTheme('foo2');
