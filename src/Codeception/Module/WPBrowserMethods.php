...
trait WPBrowserMethods
{
    ...
    /**
     * Assert a plugin is not activated in the plugins list.
     *
     * The method will **not** navigate to the plugin administration screen.
     *
     * @example
     * ```php
     * $I->loginAsAdmin();
    ...
    /**
     * Assert a plugin is installed, no matter its activation status, in the plugins list.
     *
     * The method will **not** navigate to the plugin administration screen.
     *
     * @example
    ...
    /**
     * Assert a plugin is activated in the plugins list.
     *
     * The method will **not** navigate to the plugin administration screen.
     *
     * @example
    ...
    /**
     * Assert a plugin is not installed in the plugins list.
     *
     * The method will **not** navigate to the plugin administration screen.
     *
     * @example
    ...
    /**
     * In an administration screen will look for an error admin notice.
     *
     ...
     *
     * The method will try to identify the page based on the default WordPress die page
     * markup.
     *
     * @example
     * ```php
    ...
    /**
     * In an administration screen will look for an admin notice.
     *
     * Allows for class-based error checking to decouple from internationalization.
     *
     * @example
     ...
     * $I->loginAsAdmin()ja
     * $I->amOnAdminPage('/');
     * $I->seeMessage('.notice-warning.my-plugin');
     * ```
     *
     ...
     * @example
     * ```php
     * $I->amOnAdminAjaxPage(['action' => 'my-action', 'data' => ['id' => 23]]);
     * ```
     *
