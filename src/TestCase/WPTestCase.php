...
use lucatume\WPBrowser\Traits\WithCodeceptionTestCaseEnhancements;
use lucatume\WPBrowser\Traits\WithRequestTime;
...
if (version_compare(Codecept::VERSION, '3.0.0', '<')) {
    class_alias(
        '\\lucatume\\WPBrowser\\Compat\\Codeception\\Version2\\Unit',
 ...
 */
class WPTestCase extends \lucatume\WPBrowser\Compat\Codeception\Unit
{
