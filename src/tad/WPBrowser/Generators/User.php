<?php
    ...
    class User
    {
         ...
         * @var array
         */
        protected static $userRolesToLevels = array('subscriber'    => '0',
                                                    'contributor'   => '1',
                                                    'author'        => '2',
                                                    'editor'        => '7',
                                                    'administrator' => '10');
        ...
        public static function generateUserTableDataFrom($user_login, array $userData = array())
        {
            ...
            $defaultOverrides = array_intersect_key($userData, $usersTableDefaults);
            $_userData = array_merge($usersTableDefaults, $defaultOverrides);
