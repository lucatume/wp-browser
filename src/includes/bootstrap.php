...
include_once __DIR__ . '/mock-fs.php';
include_once __DIR__ . '/mock-image-editor.php';
include_once __DIR__ . '/mock-mailer.php';
include_once __DIR__ . '/speed-trap-listener.php';
