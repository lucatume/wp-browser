...
class WP_UnitTest_Factory_For_Comment extends WP_UnitTest_Factory_For_Thing {
	...
	function __construct( $factory = null ) {
		...
		$this->default_generation_definitions = ['comment_author' => new WP_UnitTest_Generator_Sequence( 'Commenter %s' ), 'comment_author_url' => new WP_UnitTest_Generator_Sequence( 'http://example.com/%s/' ), 'comment_approved' => 1, 'comment_content' => 'This is a comment'];
	}
	...
	function create_post_comments( $post_id, $count = 1, $args = [], $generation_definitions = null ) {
