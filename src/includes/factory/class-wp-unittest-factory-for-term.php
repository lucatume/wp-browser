...
class WP_UnitTest_Factory_For_Term extends WP_UnitTest_Factory_For_Thing {
	...
	function __construct( $factory = null, $taxonomy = null ) {
		...
		$this->default_generation_definitions = ['name' => new WP_UnitTest_Generator_Sequence( 'Term %s' ), 'taxonomy' => $this->taxonomy, 'description' => new WP_UnitTest_Generator_Sequence( 'Term description %s' )];
	}
